...
class OnboardingPage extends StatefulWidget {
  final bool isTutorialMode; // If true, just show tutorial without completing onboarding
...
class _OnboardingPageState extends State<OnboardingPage> {
  ...
  Widget build(BuildContext context) {
    return PopScope(
      canPop: widget.isTutorialMode, // Allow back navigation only in tutorial mode
            ...
            Expanded(
              child: PageView.builder(
                ...
                onPageChanged: (index) {
                  setState(() {
                    _currentPage = index;
                    _hasScrolledToBottom = false; // Reset scroll state on page change
                  });
                ...
                children: [
                  ...
                  Expanded(
                    ...
                    child: Column(
                      ...
                      children: [
                        SecureButton(
                          text: _currentPage < _steps.length - 1 ? 'Next' : 'Get Started',
